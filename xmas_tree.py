...
END_LENGTH: float = 150 # Длина последней ветки
STEP_LENGTH: float = 5 # Увеличение длины каждой ветки
SPACE_LENGTH: float = 20 # Расстояние между ветками
MAGIC_NUMBER: float = 28.5 # Магическое число для нижних веток, ебу как получить
BALL_CHANCE: float = 0.1 # Шанс появления шарика для каждого пикселя, если не будет пересечения с другим
BALL_SIZES: tuple[int, int] = (8, 13) # Размер шара
